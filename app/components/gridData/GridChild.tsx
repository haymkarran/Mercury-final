              ...
              >
                      ...
                      {/* Checkbox List */}
                        {currentElement.CheckboxList &&
                          currentElement.CheckboxList.map((checkboxListData, index) => (
                            checkboxListData.listIcon && (
                              <motion.div 
                                key={checkboxListData.id} 
                                className={`order-${checkboxListOrder} flex flex-row items-center w-full gap-2`}
