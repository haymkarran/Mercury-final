  ...
  return (
    ...
    <section className='m-auto w-full max-parent-grid-container-width max554px:pt-2 min555px:pt-10 max554px:pb-10 min555px:pb-20'>
        <div><h3 className='text-h3 bold'>Privacy Policy</h3><br />
            ...
            <h4 className='text-h4 bold'>Collecting and Using Your Personal Data</h4>
            ...
            <h4 className='text-h4 bold'>Tracking Technologies and Cookies</h4>
            ...
            <h4 className='text-h4 bold'>Use of Your Personal Data</h4>
            ...
            <h4 className='text-h4 bold'>Retention of Your Personal Data</h4>
            ...
            <h4 className='text-h4 bold'>Delete Your Personal Data</h4>
            ...
            <h4 className='text-h4 bold'>Security of Your Personal Data</h4>
            ...
            <h4 className='text-h4 bold'>Changes to this Privacy Policy</h4>
