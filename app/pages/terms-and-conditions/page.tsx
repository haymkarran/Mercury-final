...
export default function Privacy () {
  return (
    ...
    <section className='m-auto w-full max-parent-grid-container-width max554px:pt-2 min555px:pt-10 max554px:pb-10 min555px:pb-20'>
        <div>
        <h3 className='text-h3 bold'>Terms and Conditions</h3><br />
            Last updated: February, 2024
            Please read these terms and conditions carefully before using Our Service.<br /><br />
            <h4 className='text-h4 bold'>Interpretation and Definitions</h4><br />
            <h4 className='text-h4 bold'>Interpretation</h4>
            ...
            <h4 className='text-h4 bold'>Definitions</h4>
            For the purposes of these Terms and Conditions:
            Affiliate means an entity that controls, is controlled by or is under common control with a party, where &quot;control&quot; means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.
            Country refers to: United Arab Emirates
            Company (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Mercury Payments Services LLC, 203, Mercury Payments Services, Dubai Hills Business Park 3,.
            ...
            Website refers to Mercury, accessible from https://mercury-pay.com/
            ...
            <h4 className='text-h4 bold'>Acknowledgment</h4>
            ...
            <h4 className='text-h4 bold'>Links to Other Websites</h4>
            ...
            <h4 className='text-h4 bold'>Limitation of Liability</h4>
            ...
            <h4 className='text-h4 bold'>Governing Law</h4>
            These Terms and Conditions constitute the entire agreement between you and us. We may update these Terms and Conditions from time to time without notice, and if any provision of these Terms and Conditions is found to be invalid or unenforceable, the remaining provisions will remain in effect. These Terms and Conditions are governed by the laws of the United Arab Emirates, and any disputes arising will be resolved by the courts of United Arab Emirates.  
            ...
            <h4 className='text-h4 bold'>Contact Us</h4>
            If you have any questions about these Terms and Conditions, You can contact us:
            •	By email: info@mercury-pay.com
